    ...
    <footer className="border-t border-slate-800/50 bg-slate-950 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              100% Client-Side Document Processing. Zero server uploads. Your
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              ...
              <li>
                <a href="#verify" className="hover:text-slate-200">
                  Verify Privacy
                </a>
              </li>
              <li>
                <a
                  href="https://github.com/localvault"
                  target="_blank"
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Engineered with WebAssembly & Web APIs. Open source and verifiable
              in DevTools.
            </p>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800/30 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          <p>
            &copy; {new Date().getFullYear()} LocalVault. All processing remains
            on your browser.
          </p>
