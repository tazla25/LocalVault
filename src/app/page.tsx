    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
      ...
      <section className="text-center space-y-6 pt-8 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
          LocalVault processes PDFs, images, and sensitive files 100% inside your
          browser using WebAssembly. Your data never touches any external server.
        </p>
      ...
      <section className="space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">
            Select a tool to start processing your document locally
          </p>
        </div>
      ...
      <section
        id="verify"
        className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pt-8"
      >
        <div className="space-y-4">
          ...
          <h2 className="text-3xl font-bold text-slate-100">
            Don&apos;t Trust Us? Verify In DevTools.
          </h2>
          <p className="text-sm text-slate-400 leading-relaxed">
            Open your browser Developer Tools (F12) &rarr; Network tab at any
            time while using LocalVault. You will observe zero upload requests or
            data payloads sent to external servers.
          </p>
          <ul className="space-y-2 text-xs text-slate-300">
            ...
            <li className="flex items-center gap-2">
              ...
              <span>
                Built-in network request interceptor blocks leak attempts
              </span>
            </li>
          </ul>
        </div>
